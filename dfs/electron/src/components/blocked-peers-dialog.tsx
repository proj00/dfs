...
import { Shield, Trash2, RefreshCw, Plus, Check, X, AlertCircle } from "lucide-react"
...
export function BlockedPeersDialog({ open, onOpenChange }: BlockedPeersDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[550px]">
        <DialogHeader>
          ...
          <DialogDescription>Add, remove, or modify IP addresses and CIDR ranges in your block list.</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Button size="sm" onClick={handleAddEntry} disabled={loading || !newAddress.trim()}>
            ...
            >
              ...
              <div className="flex justify-center space-x-1">
                <Button
                  ...
                  disabled={loading}
                  title={entry.inWhitelist ? "Move to blacklist" : "Move to whitelist"}
                >
                  {entry.inWhitelist ? (
