...
import { BlockedPeersDialog } from "../src/components/blocked-peers-dialog"
import { GetNodeService } from "../src/IpcService/GetNodeService"
...
jest.mock("@/IpcService/GetNodeService", () => ({
  GetNodeService: jest.fn(() => ({
    ...
    } as unknown as BlockListResponse), // 👈 force-cast
...
describe("BlockedPeersDialog", () => {
  ...
  it("validates IP address input", async () => {
    ...
    expect(screen.getByText("Invalid IP address or CIDR range")).toBeInTheDocument()
