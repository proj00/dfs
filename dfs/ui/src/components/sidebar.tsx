...
import { ChevronRight, Clock, Download, HardDrive, Star, Upload } from "lucide-react"
...
export function Sidebar({ currentFolder, navigateToFolder }: SidebarProps) {
    ...
    const handlePublish = () => {
        console.log(`Publishing container ${selectedContainer} to tracker ${publishTrackerUri}`)
    ...
    const handleDownload = () => {
        console.log(`Downloading container ${downloadContainerGuid} from tracker ${downloadTrackerUri}`)
    ...
    return (
        <div className="w-64 border-r bg-background p-4 hidden md:block">
            ...
            <div className="mt-6 space-y-2">
                <Button variant="outline" className="w-full justify-start" onClick={() => setPublishDialogOpen(true)}>
                    <Upload className="mr-2 h-4 w-4" />
                    Publish to Tracker
                </Button>

                <Button variant="outline" className="w-full justify-start" onClick={() => setDownloadDialogOpen(true)}>
            ...
            <Dialog open={publishDialogOpen} onOpenChange={setPublishDialogOpen}>
                <DialogContent className="sm:max-w-[425px]">
                    <DialogHeader>
                        ...
                        <DialogDescription>Select a container and enter a tracker URI to publish your container.</DialogDescription>
                    </DialogHeader>
                    ...
                    <DialogFooter>
                        <Button type="submit" onClick={handlePublish} disabled={!selectedContainer || !publishTrackerUri}>
                            Publish
                        </Button>
                    </DialogFooter>
                </DialogContent>
            ...
            <Dialog open={downloadDialogOpen} onOpenChange={setDownloadDialogOpen}>
                <DialogContent className="sm:max-w-[425px]">
                    <DialogHeader>
                        ...
                        <DialogDescription>Enter a container GUID and tracker URI to download a container.</DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-4 py-4">
                        <div className="grid grid-cols-4 items-center gap-4">
                    ...
                    <DialogFooter>
                        <Button type="submit" onClick={handleDownload} disabled={!downloadContainerGuid || !downloadTrackerUri}>
                            Download
                        </Button>
                    </DialogFooter>
                </DialogContent>
