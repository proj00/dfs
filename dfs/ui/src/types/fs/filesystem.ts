...
class FileSystemObject$Type extends MessageType<FileSystemObject> {
    constructor() {
        super("fs.FileSystemObject", [
            ...
            { no: 4, name: "directory", kind: "message", oneof: "type", T: () => Directory },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* fs.File file */ 3:
                    message.type = {
                        oneofKind: "file",
                        file: File.internalBinaryRead(reader, reader.uint32(), options, (message.type as any).file)
                    };
                    break;
                case /* fs.Directory directory */ 4:
                    message.type = {
                        oneofKind: "directory",
                        directory: Directory.internalBinaryRead(reader, reader.uint32(), options, (message.type as any).directory)
                    };
                    break;
                case /* fs.Link link */ 5:
                    message.type = {
                        oneofKind: "link",
                        link: Link.internalBinaryRead(reader, reader.uint32(), options, (message.type as any).link)
                    };
                    break;
                default:
    ...
    internalBinaryWrite(message: FileSystemObject, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.type.oneofKind === "file")
            File.internalBinaryWrite(message.type.file, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* fs.Directory directory = 4; */
        if (message.type.oneofKind === "directory")
            Directory.internalBinaryWrite(message.type.directory, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        /* fs.Link link = 5; */
        if (message.type.oneofKind === "link")
            Link.internalBinaryWrite(message.type.link, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
...
class File$Type extends MessageType<File> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* fs.ChunkHashes hashes */ 2:
                    message.hashes = ChunkHashes.internalBinaryRead(reader, reader.uint32(), options, message.hashes);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: File, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.hashes)
            ChunkHashes.internalBinaryWrite(message.hashes, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class ChunkHashes$Type extends MessageType<ChunkHashes> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ChunkHashes): ChunkHashes {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ChunkHashes, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int32 chunkSize = 1; */
...
class Directory$Type extends MessageType<Directory> {
    constructor() {
        super("fs.Directory", [
            { no: 1, name: "entries", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 12 /*ScalarType.BYTES*/ }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Directory): Directory {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: Directory, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class ObjectWithHash$Type extends MessageType<ObjectWithHash> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ObjectWithHash): ObjectWithHash {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* fs.FileSystemObject object */ 1:
                    message.object = FileSystemObject.internalBinaryRead(reader, reader.uint32(), options, message.object);
                    break;
                case /* bytes hash */ 2:
    ...
    internalBinaryWrite(message: ObjectWithHash, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* fs.FileSystemObject object = 1; */
        if (message.object)
            FileSystemObject.internalBinaryWrite(message.object, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* bytes hash = 2; */
...
class ObjectList$Type extends MessageType<ObjectList> {
    constructor() {
        super("fs.ObjectList", [
            { no: 1, name: "data", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ObjectWithHash }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated fs.ObjectWithHash data */ 1:
                    message.data.push(ObjectWithHash.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: ObjectList, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.data.length; i++)
            ObjectWithHash.internalBinaryWrite(message.data[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
