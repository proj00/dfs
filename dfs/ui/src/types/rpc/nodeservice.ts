...
export namespace NodeService {
  ...
  export class ObjectFromDiskOptions extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.path.length) writer.writeString(1, this.path);
      if (this.chunkSize != 0) writer.writeInt64(2, this.chunkSize);
      if (!w) return writer.getResultBuffer();
    }
    static deserialize(
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          case 1:
            ...
            break;
          case 2:
            message.chunkSize = reader.readInt64();
            break;
          default:
            reader.skipField();
        }
  ...
  export abstract class UnimplementedNodeServiceService {
    static definition = {
      PickObjectPath: {
        path: "/NodeService.NodeService/PickObjectPath",
        requestStream: false,
      ...
      GetObjectPath: {
        path: "/NodeService.NodeService/GetObjectPath",
        requestStream: false,
        responseStream: false,
      ...
      RevealObjectInExplorer: {
        path: "/NodeService.NodeService/RevealObjectInExplorer",
        requestStream: false,
        responseStream: false,
        requestSerialize: (message: dependency_2.rpc_common.Hash) =>
          Buffer.from(message.serialize()),
      ...
      GetAllContainers: {
        path: "/NodeService.NodeService/GetAllContainers",
        requestStream: false,
        responseStream: false,
      ...
      GetDownloadProgress: {
        path: "/NodeService.NodeService/GetDownloadProgress",
        requestStream: false,
        responseStream: false,
        requestSerialize: (message: dependency_2.rpc_common.Hash) =>
          Buffer.from(message.serialize()),
      ...
      GetContainerObjects: {
        path: "/NodeService.NodeService/GetContainerObjects",
        requestStream: false,
        responseStream: false,
      ...
      GetContainerRootHash: {
        path: "/NodeService.NodeService/GetContainerRootHash",
        requestStream: false,
        responseStream: false,
        requestSerialize: (message: dependency_2.rpc_common.Guid) =>
          Buffer.from(message.serialize()),
      ...
      ImportObjectFromDisk: {
        path: "/NodeService.NodeService/ImportObjectFromDisk",
        requestStream: false,
        responseStream: false,
      ...
      PublishToTracker: {
        path: "/NodeService.NodeService/PublishToTracker",
        requestStream: false,
        responseStream: false,
      ...
      DownloadContainer: {
        path: "/NodeService.NodeService/DownloadContainer",
        requestStream: false,
        responseStream: false,
      ...
      CopyToClipboard: {
        path: "/NodeService.NodeService/CopyToClipboard",
        requestStream: false,
        responseStream: false,
  ...
  export class NodeServiceClient extends grpc_1.makeGenericClientConstructor(
    UnimplementedNodeServiceService.definition,
    "NodeService",
    {},
  ) {
    constructor(
